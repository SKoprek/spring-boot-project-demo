...
public class Constans {
    ...
    ////////////////////////////////////////////
    //OPEN
    public static final String OPEN_FOR_ALL_PING ="/api/ping/**";
    public static final String OPEN_FOR_ALL_AUTH ="/api/auth/**";
    //ADMIN
    public static final String OPEN_FOR_ADMIN = "/api/admin/**";
